 ...
 * and extracts the user's intended operation. It handles:
 * - Algorithm selection via -a flag
 * - Help requests via -h or --help flags  
 * - Filename and expected hash extraction
 * 
 * The parsing follows a flexible approach that allows arguments in any order,
 * while enforcing required constraints and providing clear error messages.
 * 
 ...
 * 
 * @return int        Success status: 1 if parsing successful, 0 if errors occurred
 * 
 * Error Handling:
 ...
 * 
 * Design Notes:
 * - Uses pointer-to-pointer parameters to "return" multiple values
 * - Processes arguments sequentially with clear precedence rules
 * - Provides specific, actionable error messages for user guidance
 * ===================================================================
 */
